                ...
                <div class="restaurant-content">
                    <div class="restaurant-info">
                        ...
                        <div class="restaurant-rating">
                            ...
                            <span class="restaurant-reviews">(${restaurant.avis} avis)</span>
                        </div>
                    </div>
                    <div class="restaurant-specialite">
                        <i class="fas fa-utensils"></i> <strong>Spécialité:</strong> ${restaurant.specialite}
                    </div>
...
async function loadRestaurants() {
    try {
        const response = await fetch('restaurants_photos.json');
